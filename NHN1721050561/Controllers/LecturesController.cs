...
using NHN1721050561.Models;

namespace NHN1721050561.Controllers
{
    public class LecturesController : Controller
    {
        private BaiTapDBcontext db = new BaiTapDBcontext();
        ...
        {
            var LCTID = db.People.OrderByDescending(m => m.PersonID).FirstOrDefault().PersonID;
            var NewID = aukey.GenerateKey("LCT", LCTID);
            ViewBag.NewLCTID = NewID;
            return View();
        }
